...
export const invertedStaticMapLW = {
    ...
    sahashralaHut:{x:1216,y:660, title:'Sahashrala\'s Hut', itemCount: 3,
        ...
        validate(items, dungeons) {
            return regionHelper.northEastLW(items, dungeons) && items.moonpearl && items.bombs;
        }
    },
    sahashrala:{x:1216,y:680, title:'Sahashrala', itemCount: 1,
        ...
        validate(items, dungeons) {
            ...
            return retval && regionHelper.northEastLW(items, dungeons);
        }
    },
    potionShop:{x:1201, y:502, title:'Potion Shop', itemCount: 1,
        req:[],
        validate(items){
            return items.mushroom && regionHelper.northEastLW(items, dungeons) && items.moonpearl;
    }},
    zora:{x:1457, y:187, title:'King Zora (500 Rupees)', itemCount: 1,
        req:[],
        validate(items, dungeons){
            return  regionHelper.northEastLW(items, dungeons) && items.moonpearl
    ...
    zoraLedge:{x:1427, y:187, title:'Zora Ledge', itemCount: 1,
        req:[],
        validate(items, dungeons){
        return regionHelper.northEastLW(items, dungeons) && items.moonpearl && items.flippers;
    }},
    ...
    pedestal: {x:62, y:74, title:'Master Sword Pedestal', itemCount: 1,
        ...
        validate(items, dungeons){
            ...
            return regionHelper.northWestLW(items, dungeons) && rb === 2 && g;
    }},
    kingTomb: {x: 902, y: 444, title:'King\'s Tomb', itemCount: 1,
        req:[],
        validate(items, dungeons){
            return regionHelper.northWestLW(items, dungeons)
                && items.boots && items.moonpearl
                && items.glove === 2;
    }},
    tavern:{x: 240, y:850, title:'Kakariko Tavern', itemCount: 1,
        req:[], validate(items, dungeons){
        return regionHelper.northWestLW(items, dungeons) && items.moonpearl;
    }},
    chickenHut: {x: 146, y:814, title:'Chicken Hut', itemCount: 1,
        req:[], validate(items, dungeons){
        return regionHelper.northWestLW(items, dungeons) && items.moonpearl && items.bombs;
    }},
    ...
    pegasusRock:{x:595,y:440, title:'Pegasus Rocks', itemCount: 1,
        req:[], validate(items, dungeons){
        return regionHelper.northWestLW(items, dungeons) && items.moonpearl && items.boots;
    }},
    bottleMerchant: {x:144,y:698, title:'Bottle Merchant (100 Rupees)', itemCount: 1, req:[], validate(){return true;}},
    ...
    sickKid:{x:234,y:807, title:'Sick Kid', itemCount: 1,
        req:[], validate(items, dungeons){
        return regionHelper.northWestLW(items, dungeons) && items.jar > 0;
    }},
    ...
    lumberjackTree:{x:450,y:110, title:'Lumberjack Tree', itemCount: 1,
        req:[], validate(items, dungeons){
            return regionHelper.northWestLW(items, dungeons) && dungeons.aga.boss && items.boots;
        }
    },
    graveyardLedge:{x:855,y:416, title:'Graveyard Ledge', itemCount: 1,
        req:[],
        validate(items, dungeons){
        return items.moonpearl && items.bombs && regionHelper.northWestLW(items, dungeons);
    }},
    ...
    sanctuary:{x:691, y:410, title:'Sanctuary', itemCount: 1, req:[], validate(){return true;}},
    aginahCave: {x:298,y:1242, title:'Aginah Cave', itemCount: 1,
        req:[], validate(items){
        return regionHelper.southLW(items, dungeons) && items.moonpearl && items.bombs;
    }},
    ...
    hobo: {x:1059,y:1045, title:'Hobo Under the Bridge', itemCount: 1,
        req:[], validate(items){
        return regionHelper.southLW(items, dungeons) && items.moonpearl && items.flippers;
    }},
    bombosTablet: {x:328,y:1380, title:'Bombos Tablet', itemCount: 1,
        req:[],
        validate(items, dungeons){
            return items.book && items.sword > 1 && regionHelper.southLW(items, dungeons);
    }},
    ...
    library: {x:243,y:990, title:'Library', itemCount: 1,
        req:[], validate(items){
        return regionHelper.southLW(items, dungeons) && items.moonpearl && items.boots;
    }},
    ...
    fluteSpot: {x:435,y:992, title:'Flute Spot', itemCount: 1,
        req:[], validate(items, dungeons){
        return regionHelper.southLW(items, dungeons) && items.moonpearl && items.shovel;
    }},
