...
export const standardStaticMapLW = {
    ...
    lwHideout:{x:283,y:194, title:'Lost Woods Hideout', itemCount: 1, req:[], validate(){return true;}},
    ...
    floodTreasure:{x:677,y:1394, title:'Floodgate Sunken Treasure', itemCount: 1, req:[], validate(){return true;}},
    linkHouse: {x:820,y:1037, title:'Link\'s House', itemCount: 1, req:[], validate(){return true;}},
