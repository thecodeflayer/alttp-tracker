...
export const staticMapLW = {
    ...
    magicBat:{x:486,y:844, title:'Magic Bat', desc: '',
        req:['items/powder1', 'items/hammer1', 'items/mirror1'],
        validate(items, dungeons){
            return items.powder
                && (items.hammer
    ...
    bombosTablet: {x:328,y:1380, title:'Bombos Tablet', desc: '',
        req:['items/mirror1','items/book1','items.sword1'],
        validate(items, dungeons){
    ...
    lakeIsland: {x:1091,y:1244, title:'Lake Hylia Island', desc: '',
        req:['items/mirror1','items/flippers1','items/moonpearl1'],
        validate(items, dungeons){
    ...
    mimicCave: {x:1266,y:140, title:'Mimic Cave', desc: '',
        req:['items.hammer1', 'items/mirror1'], validate(items, dungeons){
